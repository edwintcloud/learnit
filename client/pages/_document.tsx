...
export const title = "Learnit";
const description =
  "Learnit helps you find the best resources to learn any new topic.";
const url = `https://learnit.now.sh`;
    ...
    return (
      <html lang="en">
        <Head>
          ...
          <meta
            name="keywords"
            content="learn,new,topic,categories,machine,learning,ai,computer,science,education"
          />
